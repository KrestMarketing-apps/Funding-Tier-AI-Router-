export const knowledgebase = {
  ...
  // Source of truth: Level Debt "Unacceptable Creditors" sheet, revision 08/13/26.
  ...
  creditorRules: [
    ...
    "Army Air Force Exchange (AAFES) is not accepted.",
    ...
    "FUTURE GREEN SERVICES is not accepted.",
    ...
    "LENDKEY TECHNOLOGIES is not accepted.",
    ...
    "St Thomas Federal Credit Union is not accepted.",
    "State Department FCU is not accepted.",
    "Stream Financial is not accepted.",
    "Sun Loans is not accepted.",
