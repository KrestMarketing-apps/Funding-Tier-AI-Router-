...
export const TOOLS = [
  // ---- Agents -----------------------------------------------------------
  {
    ...
    label: "Inbound Leads / Call Handling (SOP)",
    href: "/agents/answering-inbound-calls",
    section: "Agents",
    role: "agent",
    blurb: "Contact capture, SSN collection, qualification, backend push, soft pull",
    logo: { initials: "IC", color: "#0F9D8A" },
    flagship: true,
  },
  {
    id: "call-scripts",
  ...
  },
  {
    ...
    logo: { initials: "LD", color: "#0F9D8A" },
    flagship: true,
  },
  {
    id: "elp-enrollment",
    label: "Debt Resolution Enrollment (SOP)",
    href: "/agents/debt-resolution/elite-legal-practice/enrollment-process",
    section: "Agents",
    role: "agent",
    blurb: "Salesforce walkthrough, Elite Legal Practice, Titan e-signature",
    logo: { initials: "EL", color: "#B08D57" },
    flagship: true,
  },
  {
    id: "consumer-shield-enrollment",
    label: "Debt Validation Enrollment (SOP)",
    href: "/agents/debt-validation/consumer-shield/enrollment-process",
    section: "Agents",
    role: "agent",
    // No walkthrough exists yet — see /agents/debt-validation/consumer-shield/enrollment-process
    // for what's still needed before this can be built out like the other two.
    blurb: "Consumer Shield — walkthrough not yet built",
    logo: { initials: "CS", color: "#3D6FE0" },
    flagship: true,
    wip: true,
  },
  {
    id: "tax-resolution-enrollment",
    label: "Tax Resolution Enrollment (SOP)",
    href: "/agents/tax-resolution/milestone-tax/enrollment-process",
    section: "Agents",
    role: "agent",
    // Milestone Tax Solutions. Built from the Sept 2026 Milestone training call
    // transcript, the Phase 1 script and Milestone's IRS fact sheets — no
    // screenshots or clips yet.
    blurb: "Milestone Tax — Phase 1 investigation + Phase 2 resolution",
    logo: { initials: "MT", color: "#7A4FD0" },
    flagship: true,
  },
  {
  ...
  },
  {
    id: "my-deals-pay",
    label: "My Deals & Pay",
    // Served by the funding-tier-agent-tools project through the existing
    // /agent-tools rewrite and the DELEGATED gate in middleware.ts — no page
    // or rule is needed in this repo. Each closer sees only their own deals.
    href: "/agent-tools/my-pay",
    section: "Agents",
    role: "agent",
    blurb: "Every deal you closed, when you get paid on it, and why",
  },
  ...
  href: "/admins/agent-ops",
  section: "Admins",
  role: "admin",
  blurb: "Attendance, call detail and backend reconciliation per rep",
},
  {
    id: "operating-model",
  ...
  },
  {
    id: "rep-pay-model",
    label: "Rep Pay Model",
    // Same arrangement as Operating Model directly above: served by the
    // funding-tier-profit-engine project and proxied in by the rewrite in
    // vercel.json — there is no page for it in this repo. Reads its tier and
    // ramp numbers live from that project's Operating Model defaults, so the
    // two never drift apart.
    href: "/admins/rep-pay-model",
    section: "Admins",
    role: "admin",
    blurb: "Draw + tiered commission structure — mechanism, trade-offs, 90-day ramp",
  },
  {
    id: "profit-engine",
    label: "Profit Engine",
  ...
  {
    id: "milestone-tax-profit-forecast",
    label: "Milestone Tax — Profit Forecast",
    href: "/admins/milestone-tax-profit-forecast",
    section: "Admins",
    role: "admin",
    blurb: "Tax resolution P1/P2 payouts, 12-month forecast, tier math",
  },
  {
...
/**
 * Backend Support — one chat link per backend, shown as a collapsible
 * sub-group inside Admins.
 */
export const SUPPORT = [
  {
    id: "support-level-debt",
    label: "Level Debt",
    href: "https://app.slack.com/client/T0AM7A8UKU2/C0AMBM9EBNV",
    logo: { initials: "LD", color: "#0F9D8A" },
    blurb: "Slack",
  },
  {
    ...
    href: "https://teams.microsoft.com/l/channel/19%3ASE93Yw0ZMFs_-Zv1fzl6403VvLuRhi62NmZUQTN6rlE1%40thread.tacv2/Funding%20Tier%20x%20LCS?groupId=32e20068-54b0-47cb-93ee-475fa78602e3&tenantId=407986d0-5c0a-4322-bea0-be5783fe1d6e",
    logo: { initials: "EL", color: "#B08D57" },
    blurb: "Microsoft Teams",
    // The LCS/ELP support reference used to sit in the Admins list as well,
    // which meant two doors onto the same page. It belongs here — on the
    // backend it documents — so the row carries the chat link and the
    // reference page side by side instead.
    page: { href: "/legacy-support", label: "Reference", title: "LCS/ELP — Support reference" },
  },
  {
    id: "support-consumer-shield",
    label: "Consumer Shield",
    href: "https://teams.live.com/l/invite/FBA2mu0C9EQERh1bQ",
    logo: { initials: "CS", color: "#3D6FE0" },
    blurb: "Microsoft Teams",
  },
];
