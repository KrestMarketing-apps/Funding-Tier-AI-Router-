...
export const TOOLS = [
  ...
  },
  {
    ...
    // Lives in the funding-tier-agent-tools project, reached through the
    // rewrite in vercel.json. /agent-tools still serves the same app and is
    // what the GoHighLevel Marketplace custom page points at — leave it be.
    href: "/agents/commission-simulator",
    section: "Agents",
    role: "agent",
    blurb: "Model a deal's commission",
  },
  {
    id: "bonuses",
