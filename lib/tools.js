 ...
 * sub-group inside Admins. hrefs below are placeholders (#) until the real
 * Slack/Teams links are provided — swap each one in, one line each.
 */
export const SUPPORT = [
  {
    id: "support-level-debt",
    label: "Level Debt",
    href: "#", // TODO: real Slack channel/DM link
    logo: { initials: "LD", color: "#0F9D8A" },
    blurb: "Slack",
  },
  {
    ...
    href: "#", // TODO: real Microsoft Teams chat link
    logo: { initials: "EL", color: "#B08D57" },
